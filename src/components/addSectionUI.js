            ...
            <div className="add-section-page__wrapper">
                <div className="add-section-page__content">
                    ...
                    <form className="add-section-page__form">
                        <input onChange={(event) => {setInputValue(event.currentTarget.value)}} className="input section-name" placeholder="Section name" />
                    </form>
                    <button onClick={(event) => {submitHandler(event)}} className="add-section-page__button">Add section</button>
                </div>
                <button className="add-section-page__close" onClick={props.closePage}><RxCross1/></button>
            </div>
        </section>
    )
}
